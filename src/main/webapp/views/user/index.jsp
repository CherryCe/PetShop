...
<body>
	...
	<%@ include file="/common/user/hero.jsp"%>
	<%@ include file="/common/user/video-modal.jsp"%>
	<%@ include file="/common/user/about.jsp"%>
	<%@ include file="/common/user/services.jsp"%>
	<%@ include file="/common/user/products.jsp"%>
	<%@ include file="/common/user/offer.jsp"%>
	<%@ include file="/common/user/pricing-plan.jsp"%>
	<%@ include file="/common/user/team.jsp"%>
	<%@ include file="/common/user/testimonial.jsp"%>
	<%@ include file="/common/user/blog.jsp"%>
