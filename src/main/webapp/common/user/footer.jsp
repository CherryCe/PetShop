	...
	<div class="container pt-5">
		<div class="row g-5">
			<div class="col-lg-3 col-md-6">
				...
				<p class="mb-2">
					<i class="bi bi-geo-alt text-primary me-2"></i>Hoa Xuan, BMT
				</p>
				<p class="mb-2">
					<i class="bi bi-envelope-open text-primary me-2"></i>mrpii.2k3@gmail.com
				</p>
				<p class="mb-0">
					<i class="bi bi-telephone text-primary me-2"></i>0966454404
				</p>
			</div>
			<div class="col-lg-3 col-md-6">
				<h5
	...
	<div class="container">
		<div class="row g-5">
			<div class="col-md-6 text-center text-md-start">
				<p class="mb-md-0">
					&copy; <a class="text-white" href="#">CherryCe</a>. All
					Rights Reserved.
				</p>
			</div>
			<div class="col-md-6 text-center text-md-end">
				<p class="mb-0">
					Designed by <a class="text-white" href="https://www.facebook.com/MrPii.2k3">MrPii.2k3</a>
				</p>
			</div>
		</div>
	</div>
