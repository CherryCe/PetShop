...
<div class="mb-5">
	<img class="img-fluid w-100 rounded mb-5"
		src="<c:url value='/templates/user/img/blog-1.jpg'/>" alt="">
	<h1 class="text-uppercase mb-4">Diam dolor est labore duo ipsum
		clita sed et lorem tempor duo</h1>
	<p>Sadipscing labore amet rebum est et justo gubergren. Et eirmod
		ipsum sit diam ut magna lorem. Nonumy vero labore lorem sanctus rebum
		et lorem magna kasd, stet amet magna accusam consetetur eirmod. Kasd
		...
		kasd vero.</p>
	<p>Voluptua est takimata stet invidunt sed rebum nonumy stet, clita
		...
		dolore sit invidunt.</p>
	<p>Diam dolor est labore duo invidunt ipsum clita et, sed et lorem
