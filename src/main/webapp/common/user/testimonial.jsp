			...
			<div class="col-lg-7">
				<div class="owl-carousel testimonial-carousel bg-white p-5">
					<div class="testimonial-item text-center">
						<div class="position-relative mb-4">
							<img class="img-fluid mx-auto"
								src="<c:url value='/templates/user/img/testimonial-1.jpg'/>" alt="">
							<div
						...
						<p>Dolores sed duo clita tempor justo dolor et stet lorem kasd
							...
							labore et tempor diam tempor erat. Erat dolor rebum sit ipsum.</p>
					...
					<div class="testimonial-item text-center">
						<div class="position-relative mb-4">
							<img class="img-fluid mx-auto"
								src="<c:url value='/templates/user/img/testimonial-2.jpg'/>" alt="">
							<div
								class="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white"
								style="width: 45px; height: 45px;">
								<i class="bi bi-chat-square-quote text-primary"></i>
